    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <CustomDropdown
          ...
          selectedValue={watch("day") || ""}
          onSelect={(value) => setValue("day", value as typeof DAYS[number])}
          error={errors.day}
        />
        <InputField
          label="Start Time"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <CustomDropdown
          ...
          selectedValue={watch("subjectId")?.toString() || ""}
          onSelect={(value) => setValue("subjectId", parseInt(value))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <CustomDropdown
          ...
          selectedValue={watch("teacherId") || ""}
          onSelect={(value) => setValue("teacherId", value)}
          error={errors.teacherId}
        />
        <CustomDropdown
          label="Class"
          options={classes.map((c) => ({ value: c.id?.toString() || "", label: c.name }))}
          selectedValue={watch("classId")?.toString() || ""}
          onSelect={(value) => setValue("classId", parseInt(value))}
